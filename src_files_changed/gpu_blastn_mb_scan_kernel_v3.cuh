...
#define CONSTANT_MEM_SIZE 1024
__constant__ PV_ARRAY_TYPE c_lookupArray[CONSTANT_MEM_SIZE];
...
//	__syncthreads();
	...
	while(s_index < scan_range)
	{
		...
		if (s_gpu_BlastMBLookupHasHits(c_lookupArray, s_temp, pv_array_bts))
		{  
